...
//+kubebuilder:webhook:path=/mutate-crd-lr97128-com-v1-app,mutating=true,failurePolicy=fail,sideEffects=None,groups=crd.lr97128.com,resources=apps,verbs=create;update,versions=v1,name=mapp.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-crd-lr97128-com-v1-app,mutating=false,failurePolicy=fail,sideEffects=None,groups=crd.lr97128.com,resources=apps,verbs=create;update,versions=v1,name=vapp.kb.io,admissionReviewVersions=v1
